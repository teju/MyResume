...
public class BannerLayoutNew extends FrameLayout {
    ...
    public BannerLayoutNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerLayoutNew(Context context, AttributeSet attrs, int defStyleAttr) {
