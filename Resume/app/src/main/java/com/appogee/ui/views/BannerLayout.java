...
import com.appogee.ui.views.layoutmanager.BannerLayoutManager;
import com.appogee.ui.views.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends RelativeLayout {
    ...
    public  static  int IndicatortopMargin = 70;//指示器间距
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        IndicatortopMargin = a.getInt(R.styleable.BannerLayout_top_margin, 70);
        if (mSelectedDrawable == null) {
            //绘制默认选中状态图形
            GradientDrawable selectedGradientDrawable = new GradientDrawable();
            selectedGradientDrawable.setShape(GradientDrawable.OVAL);
            selectedGradientDrawable.setColor(selectedcolor);
            selectedGradientDrawable.setSize(dp2px(8), dp2px(8));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(unselectedcolor);
            unSelectedGradientDrawable.setSize(dp2px(8), dp2px(8));
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        params.addRule(RelativeLayout.BELOW, mRecyclerView.getId());
        params.addRule(RelativeLayout.CENTER_HORIZONTAL, RelativeLayout.TRUE);
        System.out.println("IndicatortopMargin "+IndicatortopMargin);
        params.setMargins(marginLeft,IndicatortopMargin , marginRight, marginBottom);
    ...
    public void setSelectedColor(int selectedcolor) {
        try {
            ...
            mSelectedDrawable.setTint(this.selectedcolor);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void setUnselectedColor(int unselectedcolor) {
        try {
            ...
            mUnselectedDrawable.setTint(this.unselectedcolor);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                Log.d("xxx", "onScrollStateChanged "+newState);
    ...
    public interface PageIndicatorListener {
        void onRefresh(int index, int size);
    }
    ...
    protected synchronized void refreshIndicator() {
        ...
        if(pageIndicatorListener != null){
            pageIndicatorListener.onRefresh(currentIndex, bannerSize);
        }
