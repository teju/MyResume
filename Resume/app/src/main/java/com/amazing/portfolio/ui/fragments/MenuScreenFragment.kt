...
class MenuScreenFragment(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val runnable = object : Runnable {
            override fun run() {
                planet1.animate().rotationBy(360F).withEndAction(this).setDuration(3000)
                    .setInterpolator(LinearInterpolator()).start()
                planet2.animate().rotationBy(360F).withEndAction(this).setDuration(3000)
                    .setInterpolator(LinearInterpolator()).start()
                planet3.animate().rotationBy(360F).withEndAction(this).setDuration(3000)
                    .setInterpolator(LinearInterpolator()).start()
                planet4.animate().rotationBy(360F).withEndAction(this).setDuration(3000)
                    .setInterpolator(LinearInterpolator()).start()
                planet5.animate().rotationBy(360F).withEndAction(this).setDuration(3000)
                    .setInterpolator(LinearInterpolator()).start()
            }
        }

        planet1.animate().rotationBy(360F).withEndAction(runnable).setDuration(3000)
            .setInterpolator(LinearInterpolator()).start()
        planet2.animate().rotationBy(360F).withEndAction(runnable).setDuration(3000)
            .setInterpolator(LinearInterpolator()).start()
        planet3.animate().rotationBy(360F).withEndAction(runnable).setDuration(3000)
            .setInterpolator(LinearInterpolator()).start()
        planet4.animate().rotationBy(360F).withEndAction(runnable).setDuration(3000)
            .setInterpolator(LinearInterpolator()).start()
        planet5.animate().rotationBy(360F).withEndAction(runnable).setDuration(3000)
            .setInterpolator(LinearInterpolator()).start()
